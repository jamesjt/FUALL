"""
Compile Apology originals + output JSON into Plato - Apology.csv.
...
OUTPUT_CSV = os.path.join(BUILD_DIR, '..', 'Plato - Apology.csv')
...
def main():
    ...
    rows.append({
        ...
        'Chapter': '',
        'Thought': '',
        'D: Original': '<a href="https://www.gutenberg.org/cache/epub/1656/pg1656-images.html">Apology - Plato (Benjamin Jowett translation)</a>',
        'D: Narrative': '<a href="https://www.gutenberg.org/cache/epub/1656/pg1656-images.html">Apology - Plato</a> - Narrative',
        'D: Refashioned': '<a href="https://www.gutenberg.org/cache/epub/1656/pg1656-images.html">Apology - Plato</a> - Refashioned',
        'D: Elegant': '',
        'D: Summary': '',
        'D: Distilled': '',
        'Notes': ''
    ...
    originals_path = os.path.join(BUILD_DIR, 'apology_originals.json')
    output_path = os.path.join(BUILD_DIR, 'apology_output.json')

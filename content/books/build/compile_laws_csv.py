"""
Compile all Laws book originals + output JSONs into Plato - Laws.csv.
...
OUTPUT_CSV = os.path.join(BUILD_DIR, '..', 'Plato - Laws.csv')
...
def main():
    ...
    rows.append({
        ...
        'Chapter': '',
        'Thought': '',
        'D: Original': '<a href="http://classics.mit.edu/Plato/laws.html">Laws - Plato (Benjamin Jowett translation)</a>',
        'D: Narrative': '<a href="http://classics.mit.edu/Plato/laws.html">Laws - Plato</a> - Narrative',
        'D: Refashioned': '<a href="http://classics.mit.edu/Plato/laws.html">Laws - Plato</a> - Refashioned',
        'D: Elegant': '',
        'D: Summary': '',
        'D: Distilled': '',
        'Notes': ''
    ...
    for book_num in range(1, 13):
        originals_path = os.path.join(BUILD_DIR, f'laws_book{book_num}_originals.json')
        output_path = os.path.join(BUILD_DIR, f'laws_book{book_num}_output.json')
